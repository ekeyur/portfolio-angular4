   ...
   projects = [
    {
      id           : 0,
      project_name : 'AirNav',
      description  : `Web app that provides turn-by-turn navigation and route view of point
                      to point trips within the Atlanta airport. Created custom graph network
                      using Dijkstra\'s algorithm and coded the majority of the back-end of the
                      site.`,
    ...
    },
    {
      ...
      description  : `Fabulari is a free app that models how to use communication devices
                      for students with disabilities. It feature of quick error and collecting
                      rewards keep the kids engaged.`,
    ...
    },
    {
      ...
      description  : `Web app to facilitate safe travel of minors on MARTA. Completed at the
                      October 2016 MARTA Hackathon and partnered with Soccer in the Streets.
                      Designed and coded entire site back-end with one other team member.`,
    ...
    { id           : 3,
      ...
      description  : `A store front for renting grills by the hour. Designed the database and
                      coded the majority of the backed with one other team member.`,
